---
name: real-estate-report-chain
description: 房地产市场调查报告撰写决策链。涵盖住宅/商业/办公/工业地产类型的专业市场调研报告撰写工作流。当用户需要撰写房地产市场分析报告、项目可行性研究、投资回报评估、市场调研报告、REITs 发行报告，或提到"决策链""市场调查报告""竞品分析""SWOT分析""运营预测"时触发。支持 5 步全流程：项目定义→框架设计→报告撰写→质量审核→排版导出。
---
...
`references/demo_case_qianhai.md` — 前海交易广场T4T5公寓市场调研报告完整案例，展示从 Step 0 到 Step 5 的实际执行结果。
